...
trainY = "/media/antor/Files/main_projects/test_set/*.jpg"
...
writer = tf.python_io.TFRecordWriter("/media/antor/Files/ML/tfrecord/sir_demo/test.tfrecords")
for i in range(len(resul)):
    print(i)
    img_y = cv2.imread("/media/antor/Files/main_projects/test_set/"+resul[i]+".jpg", cv2.IMREAD_GRAYSCALE)
